...
<div class="dashboard-container">
    ...
    <div class="col-md-4">
        <div class="glass-panel stat-card">
            ...
            <div>
                <div class="stat-value">
                    {{ Auth::guard('corporate')->user()->id_zona }}
                </div>
        ...
        <div class="col-lg-6">
            <div class="glass-panel">
                ...
                <div class="panel-body d-grid gap-3">
                    ...
                    <a href="{{ route('mis_reservas') }}" class="btn btn-outline-primary d-flex flex-column align-items-center py-2">
                        {{-- Icon: List --}}
                        ...
                        <span class="fw-bold mt-2">Mis Reservas</span>
                    </a>

                    <a href="{{ route('calendar.index') }}" class="btn btn-outline-success d-flex flex-column align-items-center py-2">
                        {{-- Icon: Calendar --}}
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M8 7V3m8 4V3m-9 8h10
                                    M5 21h14a2 2 0 002-2V7 a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span class="fw-bold mt-2">Calendario</span>
                    </a>

                    <a href="{{ route('corporate.comissions') }}" class="btn btn-outline-warning d-flex flex-column align-items-center py-2">
                        {{-- Icon: Euro --}}
                        ...
                        <span class="fw-bold mt-2">Comisiones</span>
                    </a>

                    <a href="{{ route('profile.edit') }}" class="btn btn-outline-secondary d-flex flex-column align-items-center py-2">
                        {{-- Icon: Cog --}}
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
                        ...
                        <span class="fw-bold mt-2">Ajustes de cuenta</span>
                    </a>
